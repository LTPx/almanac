      ...
      <DialogContent className="max-w-md z-[200] border-border/50 bg-gradient-to-b from-card via-card to-background overflow-hidden p-8">
              ...
              {isOpen && (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="relative bg-card rounded-full p-2 shadow-lg"
                  >
                    <div className="bg-gradient-to-br from-amber-500/20 to-orange-500/20 p-6 rounded-full shadow-[0_0_30px_rgba(245,158,11,0.3)]">
                      <AlertCircle className="h-14 w-14 text-amber-500 stroke-[2.5]" />
                    </div>
                  </motion.div>
        ...
        <DialogFooter className="mb-2 relative z-10 mt-8">
          ...
          >
            ...
            <Button
              variant="ghost"
              className="w-full text-muted-foreground hover:text-foreground transition-colors py-6 flex items-center justify-center gap-2 group"
              size="lg"
              onClick={() => {
                close();
                if (onEndSession) {
