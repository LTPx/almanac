...
export default function SubscriptionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#1881F0] to-[#1F960D]" />
      ...
      <div className="relative z-10 flex flex-col h-full overflow-y-auto">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 left-4 text-white/80 hover:text-white z-20"
        >
          <X className="w-6 h-6" />
        </button>
        ...
        <div className="flex flex-col items-center px-6 pt-14 pb-8 flex-1">
          ...
          <p className="text-white/80 text-sm text-center mt-5 mb-6">
            Pago recurrente automático, cancela{"\n"}cuando quieras
          </p>
