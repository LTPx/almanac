  ...
  try {
    ...
    for (const curriculum of curriculums) {
      ...
      if (!existingTranslation) {
        ...
        console.log(`  ⏭️  Curriculum ya tiene traducción EN: ${curriculum.title}`)
      }
    }
    ...
    for (const question of questions) {
      ...
      if (!existingTranslation) {
        ...
        console.log(`  ✅ Question migrada: ${question.title.substring(0, 50)}...`)
      } else {
        console.log(`  ⏭️  Question ya tiene traducción EN: ${question.title.substring(0, 50)}...`)
      }
    }
    ...
    console.log('ℹ️  Los datos originales siguen intactos en las columnas originales\n')
  } catch (error) {
